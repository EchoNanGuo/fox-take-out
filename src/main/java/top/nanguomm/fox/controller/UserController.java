...
import top.nanguomm.fox.domain.user.DTO.UserLoginDTO;
import top.nanguomm.fox.domain.user.DTO.UserRegisterDTO;
import top.nanguomm.fox.domain.user.PO.UserPO;
import top.nanguomm.fox.domain.user.VO.UserVO;
import top.nanguomm.fox.service.IUserService;
import top.nanguomm.fox.utils.MailUtil;
...
public class UserController {
    ...
    public Result<Object> code(@ApiParam("邮箱") @RequestParam String mail) {
        ...
        //发送验证码
        mailUtil.sendMail(mail, "小狐狸外卖", "这是小狐狸外卖的注册码:" + code +
                "------请勿随意交给他人！！！");
        //生成验证码放入session
        log.info("验证码:{}", code);
        //存入Redis，有效时间三分钟
